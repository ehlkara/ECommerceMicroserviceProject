...
public class UpdateOrderHandler(IApplicationDbContext dbContext) : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    {
        var updatedShippingAddress = Address.Of(orderDto.ShipppingAddress.FirstName, orderDto.ShipppingAddress.LastName, orderDto.ShipppingAddress.EmailAddress, orderDto.ShipppingAddress.AddressLine, orderDto.ShipppingAddress.Country, orderDto.ShipppingAddress.State, orderDto.ShipppingAddress.ZipCode);
