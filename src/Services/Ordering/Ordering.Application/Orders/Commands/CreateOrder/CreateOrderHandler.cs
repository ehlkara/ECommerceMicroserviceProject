...
public class CreateOrderHandler(IApplicationDbContext dbContext) : ICommandHandler<CreateOrderCommand, CreateOrderResult>
{
    ...
    {
        var shippingAddress = Address.Of(orderDto.ShipppingAddress.FirstName, orderDto.ShipppingAddress.LastName, orderDto.ShipppingAddress.EmailAddress, orderDto.ShipppingAddress.AddressLine, orderDto.ShipppingAddress.Country, orderDto.ShipppingAddress.State, orderDto.ShipppingAddress.ZipCode);
